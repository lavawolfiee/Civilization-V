...
#endif
    RangeUnit* currentUnit = new RangeUnit(30, 5, 4, 3, 10);
#ifdef debug
...
#endif
    MeleeUnit* currentUnit = new MeleeUnit(50, 10, 3, 1);
#ifdef debug
...
#endif
    CavalryUnit* currentUnit = new CavalryUnit(40, 15, 7, 1);
#ifdef debug
...
#endif
    WorkerUnit* currentUnit = new WorkerUnit(3);
#ifdef debug
