...
void ModernRangeUnit::render(Batch batch) {
...
void ModernMeleeUnit::render(Batch batch) {
...
void ModernCavalryUnit::render(Batch batch) {
...
void ModernWorkerUnit::render(Batch batch) {
...
void ModernSettlerUnit::render(Batch batch) {
