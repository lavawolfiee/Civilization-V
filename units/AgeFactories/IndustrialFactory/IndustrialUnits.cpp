...
void IndustrialRangeUnit::render(Batch batch) {
...
void IndustrialMeleeUnit::render(Batch batch) {
...
void IndustrialCavalryUnit::render(Batch batch) {
...
void IndustrialWorkerUnit::render(Batch batch) {
...
void IndustrialSettlerUnit::render(Batch batch) {
